...
namespace Attassa
{
    ...
    {
        /*Consumer settings from 500px*/
        private string _consumerKey = "HJFMg2LvexMhIKrDs2qaVUxNem27kAxhdfiAYJMW";
        private string _consumerSecret = "mPdJjtpeyXvRaUQaAaHP7KJMOWWAh8NfSf3T5NuO";

        public enum Method { GET, POST, PUT, DELETE };
        public const string USER_AGENT = "kinefinity";
        public const string REQUEST_TOKEN = "https://api.500px.com/v1/oauth/request_token";
        public const string AUTHORIZE = "https://api.500px.com/v1/oauth/authorize";
        public const string ACCESS_TOKEN = "https://api.500px.com/v1/oauth/access_token";
        public const string CALLBACK = "http://a.freeatnet.com/oauth_callback.php";
        ...
        /// <summary>
        /// Get the 500px request token using the consumer key and secret.  Also initializes tokensecret
        /// </summary>
        ...
        /// <summary>
        /// Get the link to 500px's authorization page for this application.
        /// </summary>
        ...
        public string APIWebRequest(string method, string url, string postData)
        {
            ...
            webRequest.Headers.Add("Authorization", "OAuth realm=\"http://developers.500px.com/\",oauth_consumer_key=\"" + this.ConsumerKey + "\",oauth_token=\"" + this.Token + "\",oauth_signature_method=\"HMAC-SHA1\",oauth_signature=\"" + HttpUtility.UrlEncode(sig) + "\",oauth_timestamp=\"" + timeStamp + "\",oauth_nonce=\"" + nonce + "\",oauth_verifier=\"" + this.Verifier + "\", oauth_version=\"1.0\"");
